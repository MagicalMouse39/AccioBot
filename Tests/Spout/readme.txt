...
Spout 2.007 is a portable installation that can be copied to any folder. Refer to the Setup.pdf document for instructions.
  
PLUGINS

Most applications no longer require a plugin, but have Spout functions built in.
